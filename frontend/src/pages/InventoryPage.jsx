...
const InventoryPage = ({ onInventoryUpdate }) => {
 ...
 const productDetails = selectedItem ? findProductDetails(selectedItem.product) : {};
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-1 gap-4">
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-sm">
                      ...
                      <div className="font-semibold text-gray-800">{productDetails.description || "No description available"}</div>
                    </div>

                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-sm">
                      <div className="text-xs font-medium uppercase text-gray-500 mb-1">Purchase Price</div>
                      <div className="font-semibold text-gray-800">₱{productDetails.purchase_price || "N/A"}</div>
                    </div>
